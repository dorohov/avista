...
$("img").addClass("img-responsive"),$(".text-block ul").addClass("ul-site");var url=window.location.pathname;$('.navbar-nav a[href="'+url+'"]').parent().addClass("active"),$('._fs__navbar a[href="'+url+'"]').parent().addClass("active"),$('.tabs-site a[href="'+url+'"]').parent().addClass("active"),$('.services-dropdown .dropdown-menu a[href="'+url+'"]').parent().addClass("active"),"/"!=url&&$('<li><a href="/">Главная</a></li>').prependTo($(".navbar-nav")),$(".text-block table").addClass("table table-bordered"),$("._sppc__item").hover(function(){$(this).addClass("active")},function(){$(this).removeClass("active")}),$(".navbar-site .dropdown").hover(function(){$(this).addClass("open")},function(){$(this).removeClass("open")}),$("._ipc__slider").owlCarousel({margin:0,loop:!0,items:1,nav:!1,dots:!0,navText:[],autoplay:!0,autoplayTimeout:1e4}),$(".teachers-list").owlCarousel({margin:35,navText:[],nav:!0,dots:!1,smartSpeed:500,responsive:{0:{items:1},768:{items:2},1025:{items:3},1600:{items:4}}});var left=0,top=0,element=$(".parallax__for-peoples"),element1=$(".header-site");if(element.length&&element1.length){var offset={left:element.offset().left,top:element.offset().top};element.bind("mousemove",function(e){left=e.pageX-offset.left,top=e.pageY-offset.top,$(this).css({backgroundPosition:"-"+.03*left+"px -"+.01*top+"px"})})}if(element1.length){var offset1={left:element1.offset().left,top:element1.offset().top};element1.bind("mousemove",function(e){left=e.pageX-offset1.left,top=e.pageY-offset1.top,$(this).css({backgroundPosition:"-"+.03*left+"px top"})})}$(".fancybox").fancybox({prevEffect:"none",nextEffect:"none"}),$(".fancybox-buttons").fancybox({openEffect:"none",closeEffect:"none",prevEffect:"none",nextEffect:"none",closeBtn:!1,helpers:{title:{type:"inside"},buttons:{}},afterLoad:function(){this.title=this.title}});
...
var h_window=$(window).height(),w_window=$(window).width(),h_navbar=$(".navbar-site").outerHeight(!0),h_navbar_header=$(".navbar-header").outerHeight(!0),h_navbar_fixed=$(".navbar-fixed-top").outerHeight(!0),h_header=$(".header-site").outerHeight(!0),h_footer=$(".footer-site").outerHeight(!0),h_resize=h_window-h_navbar-h_footer,h_resize_map=h_window-h_header-50,h_resize_xs=h_window,h_navbar_collapse=h_window-h_navbar_header;device.mobile()||device.tablet()?($(".navbar").addClass("navbar-fixed-top"),$(".navbar-contacts__cols").appendTo(".navbar-collapse__row"),$("._tipc__item-preview").prependTo("._tipc__content"),$(".form-site").css("padding-bottom",h_footer)):$(".navbar-site .dropdown .dropdown-toggle").on("click.azbn",function(e){e.preventDefault();var a=$(this),o=a.attr("href");window.location.href=o}),device.mobile()?($(".navbar-contacts__cols").appendTo(".navbar-collapse__row"),$(".content-site.second").removeAttr("style"),$(".navbar-collapse .navbar-collapse__row").css("height","auto")):($(".content-site.second").css("min-height",h_resize),$(".navbar-collapse .container").removeAttr("style")),$("nav.navbar-fixed-top").autoHidingNavbar();
	}).trigger('resize');
